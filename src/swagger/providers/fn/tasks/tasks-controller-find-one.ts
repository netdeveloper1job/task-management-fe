...
export function tasksControllerFindOne(http: HttpClient, rootUrl: string, params: TasksControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<TaskWithResponse>> {
